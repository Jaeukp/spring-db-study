package com.tjn.controller.Account;
...
// 서버 프로그램(백엔드, backend)
// 요청에 대한 적절한 응압을 제공해주는 프로그램
@RestController
// 컨트롤러에 RequestMapping을 사용하여
// value 경로의 요청을 컨트롤러 내부의 메서드로 실행
// GET.../accounts => Accountcontroller => method로 실행
//spring framework -> fastxml.jackson, 이용해서
//        자바 객체 -> JOSN으로 만들어줘
//        JSON(javascript script object notation)
//        : 자바스크립트 객체 표기법
//        : 문자열
//        : 일반적으로 client(브라우저, 앱)-sever간 통신에
//        : 데이터를 주고받을 때 사용하는 데이터 형식
//@Controller
// = 요청에 대한 응답을 처리하는 메서드를 정의
//     -> 응답이 데이터, 문자열, 숫자, 웹페이지, 파열
//@ResponseBody
//     -> 응답 형식이 객체만(object, list...) JSON 형식으로 변환해서 반환함
//@RestController
//
...
public class AccountController {
    ...
    public void func() {
        ...
        // intellij에서 룸복 라이브러리를 사용중이면 getter/setter 등을
        // 쓸 수 있게 해주는것
        acc.getAno();
        acc.setAno("002");
    }
